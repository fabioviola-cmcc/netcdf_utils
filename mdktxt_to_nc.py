...
if __name__ == "__main__":
    ...
    if (not inputFile) and (not outputFile) and (not timeStep):
    ...
    # 4. read and copy latitude and longitude
    u10_values = {}
    v10_values = {}
